...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument("--openobserve-username", default=os.getenv("OPENOBSERVE_USERNAME", "root@example.com"))
    run_parser.add_argument("--openobserve-password", default=os.getenv("OPENOBSERVE_PASSWORD", "Complexpass#123"))
...
def handle_list_safe_abilities(args: argparse.Namespace) -> int:
    if args.platform != "linux":
        raise ValueError("list-safe-abilities currently only supports --platform linux")
